...
$('#crazy_traveller').delay(5000).fadeOut(1500);
$("#textanime").delay(4000).fadeIn(1500);
})
...
Router.route('/game', {
    ...
    layoutTemplate: 'main',
     onAfterAction: function() {
      ...
      SEO.config({
        title: "Topicerrati.com - Question and Quantify Everything including games",
        meta: {
          'description': "Social Network where we question and quantify everything,  even the games we play"
        },
        og: {
          'title': "Topicerrati.com - Question and Quantify Everything including games",
          'description': "Social Network where we question and quantify everything,  even the games we play ",
